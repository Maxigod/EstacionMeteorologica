...
#define PIN_ANEMOMETRO 26
#define TIEMPO_DORMIDO 60 // segundos
...
void iniciarSensores() {
  ...
  if (status) {
    ...
    Serial.println("Conectado sensor BMP280");
    delay(1000);
  } else {
  ...
  if (!ready) {
    ...
    Serial.println("Conectado sensor AHT20");
    delay(1000);
  }
